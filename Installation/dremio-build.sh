...
pct set 300 -onboot 1 -cores 10 -memory 30000 -net0 name=eth0,bridge=vmbr0,gw=192.168.2.1,ip=192.168.2.60/24,type=veth
pct set 301 -onboot 1 -cores 10 -memory 30000 -net0 name=eth0,bridge=vmbr0,gw=192.168.2.1,ip=192.168.2.61/24,type=veth
pct set 302 -onboot 1 -cores 10 -memory 30000 -net0 name=eth0,bridge=vmbr0,gw=192.168.2.1,ip=192.168.2.62/24,type=veth
pct set 303 -onboot 1 -cores 10 -memory 30000 -net0 name=eth0,bridge=vmbr0,gw=192.168.2.1,ip=192.168.2.63/24,type=veth
pct set 304 -onboot 1 -cores 10 -memory 30000 -net0 name=eth0,bridge=vmbr0,gw=192.168.2.1,ip=192.168.2.64/24,type=veth
...
#
#pct exec 300 -- mkdir -p /mnt/cachemanagerdisk/dir1 /mnt/cachemanagerdisk/dir2 /mnt/cachemanagerdisk/dir3 /mnt/cachemanagerdisk/dir4
#pct exec 301 -- mkdir -p /mnt/cachemanagerdisk/dir1 /mnt/cachemanagerdisk/dir2 /mnt/cachemanagerdisk/dir3 /mnt/cachemanagerdisk/dir4
#pct exec 302 -- mkdir -p /mnt/cachemanagerdisk/dir1 /mnt/cachemanagerdisk/dir2 /mnt/cachemanagerdisk/dir3 /mnt/cachemanagerdisk/dir4
#pct exec 303 -- mkdir -p /mnt/cachemanagerdisk/dir1 /mnt/cachemanagerdisk/dir2 /mnt/cachemanagerdisk/dir3 /mnt/cachemanagerdisk/dir4
#pct exec 304 -- mkdir -p /mnt/cachemanagerdisk/dir1 /mnt/cachemanagerdisk/dir2 /mnt/cachemanagerdisk/dir3 /mnt/cachemanagerdisk/dir4
#
